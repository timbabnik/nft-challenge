...
function NFTDropPage({ collection }: Props) {
  ...
  return (
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
        ...
        <div className="bg-gradient-to-br from-purple-900 to-black lg:col-span-4">
            <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
                <div className="bg-gradient-to-br from-purple-100 to-purple-600 p-2 rounded-xl">
                    <img className="w-44 rounded-xl object-cover lg:h-96 lg:w-72" src={"https://i.postimg.cc/50Q2Kh8s/Group-3-3.png"} alt="" />
                </div>
                <div className="text-center p-5 space-y-2">
                    ...
                    <h2 className="text-xl text-gray-300">
                        A collection of crown´s that makes you a KING of your own destiny
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div className="flex flex-1 flex-col p-12 lg:col-span-6">
            <header className="flex items-center justify-between">
                <Link href={"/"}>
                    <h1 className="w-25 cursor-pointer text-xl font-extralight sm:w-80">
                        The 
                        {" "}<span className="font-extrabold underline decoration-pink-600/50">TIM BABNIK</span>{" "}
                        NFT Market Place
                    </h1>
                </Link>
            ...
            <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center">
                ...
                <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">The King´s crown | NFT Drop</h1>
                {
                    loading ? (
